...
<x-form-container 
    ...
    description="Berikan resep obat untuk pasien"
    :back-route="route('transaksi.obat.index')"
    back-text="Kembali ke Daftar Resep">
    
    <form method="POST" action="{{ route('transaksi.obat.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-amber-700">
                        <strong>Perhatian:</strong> Pastikan stok obat mencukupi sebelum memberikan resep. Stok akan berkurang otomatis setelah transaksi disimpan.
                    </p>
                </div>
            </div>
        </div>
