...
<x-form-container 
    ...
    description="Daftarkan pegawai baru dan hubungkan dengan akun pengguna"
    :back-route="route('master.pegawai.index')"
    back-text="Kembali ke Daftar Pegawai">
    
    <form method="POST" action="{{ route('master.pegawai.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-amber-700">
                        <strong>Perhatian:</strong> Pastikan akun pengguna yang dipilih belum terhubung dengan pegawai lain. Satu akun hanya dapat dihubungkan dengan satu pegawai.
                    </p>
                </div>
            </div>
        </div>
